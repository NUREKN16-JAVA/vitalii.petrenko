...
import main.java.ua.nure.kn.petrenko_vitaliy.usermanagment.gui.MainFrame;
import main.java.ua.nure.kn.petrenko_vitaliy.usermanagment.util.Messages;
import test.java.ua.nure.kn.petrenko_vitaliy.usermanagment.database.MockDaoFactory;
...
public class MainFrameTest extends JFCTestCase {
	...
	protected void setUp() throws Exception {
		...
		try {
			...
			expectedUser = new User(20 L, firstName, lastName, now);
			user = new User(20 L, firstName, lastName, now);
			users = new ArrayList();
	...
	public void testAddUser() {
		try {
			...
			User expectedUser = new User(1 L, firstName, lastName, now);
	...
	public void testDeleteUser() {
		try {
			...
			mockUserDao.expectAndReturn("find", 20 L, expectedUser);
			mockUserDao.expectAndReturn("find", 20 L, expectedUser);
			mockUserDao.expectAndReturn("find", 20 L, expectedUser);
	...
	public void testEditUser() {
		try {
			...
			User expectedUser = new User(20 L, firstName, lastName, dateOfBirth);
			
			mockUserDao.expectAndReturn("update", user, expectedUser);
			users.remove(user);
			users.add(expectedUser);
			mockUserDao.expectAndReturn("findAll", users);
			mockUserDao.expectAndReturn("find", 20 L, this.expectedUser);
			mockUserDao.expectAndReturn("find", 20 L, expectedUser);
			mockUserDao.expectAndReturn("find", 20 L, expectedUser);
